...
class VendingMachine:
    ...
    def deposit(self,dollars=0):
        if self.amount <= 0:
            return 'Machine is out of stock. Here is your ${0}.'.format(dollars)
        else:
    ...
    def vend(self):
        if self.amount <= 0:
            ...
            return_back = self.balance - self.price
            self.balance = 0
            self.amount -= 1
            return 'Here is your {0} and ${1} change.'.format(self.name,return_back)
        elif self.balance == self.price:
            self.balance = 0
            self.amount -= 1
