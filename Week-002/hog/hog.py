...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while (num_rolls > 0):
        ...
        if add == 1:
            dead = 1
        score,num_rolls = score+add,num_rolls-1
    if dead == 1:
        score = 1
    return score
    # END PROBLEM 1
...
def both(f, g):
    ...
    """
    def say(score0, score1):     #zhe ge fi fang, ta zhi shi qu ding yi, er mei you qu zhi xing
    ...
    def say(score0,score1):
        ...
        if   who == 0:
            if( (score0 - (pre_score)) > pre_high ):
                ...
                if pre_high <= 1:
                    print((score0 - (pre_score)),'point! That\'s the biggest gain yet for Player',who)
                else :
                    print((score0 - (pre_score)),'points! That\'s the biggest gain yet for Player',who)
            pre_score = score0
        elif who == 1:
            if( (score1 - (pre_score)) > pre_high ):
                pre_high = (score1 - (pre_score))
                if pre_high <= 1:
                    print((score1 - (pre_score)),'point! That\'s the biggest gain yet for Player',who)
                else :
                    print((score1 - (pre_score)),'points! That\'s the biggest gain yet for Player',who)
            pre_score = score1
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 10
    return  num_rolls*(not(free_bacon(opponent_score)>=margin)) # Replace this statement
    # END PROBLEM 10
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    return num_rolls*(not((is_swap(score,opponent_score)*(score<opponent_score)) or (free_bacon(opponent_score)>=margin and (not is_swap(score,opponent_score)))))  # Replace this statement
    # END PROBLEM 11
